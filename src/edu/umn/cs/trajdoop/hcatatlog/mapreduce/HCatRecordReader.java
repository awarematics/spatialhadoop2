 ...
 */
class HCatRecordReader extends RecordReader<WritableComparable, SRow> {
	 ...
	 */
	@Override
	public SRow getCurrentValue() throws IOException, InterruptedException {
		return storageDriver.convertToSRow(baseRecordReader.getCurrentKey(),baseRecordReader.getCurrentValue());
	}
	/* (non-Javadoc)
